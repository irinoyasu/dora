...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create driver' do
    assert_difference('Driver.count') do
      post drivers_url,
           params: { driver: { availability_status: @driver.availability_status, driver_id: @driver.driver_id,
                               experience: @driver.experience, license_details: @driver.license_details, name: @driver.name } }
    end
